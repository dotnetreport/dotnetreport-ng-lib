...
<script type="text/html" id="report-filter">
    <div class="form-group" data-bind="attr: {id: 'filter-'+uiId }">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <!-- ko if: fieldFormat()=='Time' || fieldFormat()=='Date and Time'-->
                            ...
                            <div id="customFieldSection" data-bind="if: isFormulaField" class="custom-field-design">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row" data-bind="visible: $parent.appSettings.useSqlCustomField">
                        ...
                        <div class="card card-body">
                            ...
                            <div>
                                <div data-bind="visible: ReportType()=='Bar'" class="card card-body" style="margin-bottom: 15px">
                                    <div class="alert alert-info">
                                        <span class="fa fa-lightbulb-o fa-2x"></span>&nbsp;For Bar Graph, the first field below will show on the x-axis. All other numeric fields will show on y-axis.
                                    </div>
                                    <div class="form-group row">
                                 ...
                                 <div data-bind="visible: ReportType()=='Pie'" class="card card-body" style="margin-bottom: 15px">
                                    <div class="alert alert-info">
                                        <span class="fa fa-lightbulb-o fa-2x"></span>&nbsp;For Pie Graph, the first field below will be grouped, and the first numeric field will show as the ratio.
                                    </div>
                                    <div class="form-group row">
                                        <div class="checkbox col-6">
                                            <label>
                                ...
                                <div data-bind="visible: ReportType()=='Combo'" class="card card-body" style="margin-bottom: 15px">
                                    <div class="alert alert-info">
                                        <span class="fa fa-lightbulb-o fa-2x"></span>&nbsp;For Combo Graph, the first field below will show on the x-axis. All other numeric fields will show on y-axis, and you can choose display each series as line, bar or area.
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6">
                                            <label>
                                            ...
                                            <select class="form-select input-sm form-select-sm" data-bind="options: seriesTypes, value: comboChartType"></select>
                                        </div>
                                    </div>
                                </div>
