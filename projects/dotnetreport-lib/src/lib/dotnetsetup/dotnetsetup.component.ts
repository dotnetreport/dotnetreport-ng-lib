...
<script type="text/html" id="chart-settings">
        <div class="chart-container pull-right" data-bind="if: ReportType() === 'Bar' || ReportType() === 'Pie' || ReportType() === 'Line'">
        <button class="btn btn-light btn-sm d-flex align-items-center mt-2 chart-settings-btn" data-bind="click: toggleChartSettings" title="Chart settings">
            <i class="fa fa-cog"></i>
        </button>

        <div class="chart-settings-panel border p-2 shadow-sm" data-bind="visible: showSettings">
