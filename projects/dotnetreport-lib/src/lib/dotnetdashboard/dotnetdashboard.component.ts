...
export class DotnetdashboardComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        var dashboards: { id: any; name: any; description: any; selectedReports: any; schedule:any; userId: any; userRoles: any; viewOnlyUserId: any; viewOnlyUserRoles: any;clientId:any;canManage:any }[] | { id: number; }[] = [];
