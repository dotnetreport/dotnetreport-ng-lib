    ...
    <div data-bind="style: { 'font-size': (FontSize ? FontSize : '48px'),'text-align': Alignment ? Alignment : 'center','color': FontColor ? FontColor : '#000000','background-color':BackColor ? BackColor : '#fff' }" style="width: 100%;">
        ...
        <div data-bind="if: Rows.length > 0">
            <div data-bind="with: $parent.rows[0].Items[0]">
                ...
                <span data-bind="style: {'color': $parent.calculateRate() > 0 ? $parent.PositiveColor : $parent.NegativeColor, 'font-size': '24px'}">
    ...
    <div class="designer-container compact-designer" id="choose-data-design" style="font-size:12px;">
      ...
      <div class="card p-1 mb-2">
         <div class="card-header p-1 d-flex justify-content-between align-items-center">
          ...
          <button type="button" class="btn btn-sm btn-light" data-bind="visible: ReportID(), click: function() {activeDesign(false); if (isExpanded) isExpanded(false);}" title="Close">
            <i class="fa fa-times"></i> Close Designer
          </button>
      ...
      <div class="d-flex flex-row flex-wrap gap-2 compact-filters needs-validation">
        ...
        <!-- Custom Field -->
        <div class="card flex-fill expandable-panel" id="customFieldPanel" data-bind="visible: isFormulaField">
            <div class="card-header p-1">
            <i class="fa fa-magic"></i> Custom Field
            </div>
            <div class="card-body p-1 custom-field-design" style="max-height: 400px; overflow-y: auto; overflow-x: hidden;">
                <div data-bind="template: 'custom-field-designer', data: $data"></div>
            </div>
        </div>

        <div class="card flex-fill expandable-panel" id="customFunctionPanel" data-bind="visible: isFunctionField">
            <div class="card-header p-1">
            <i class="fa fa-magic"></i> Function Field
            </div>
            <div class="card-body p-1 custom-field-design" style="max-height: 400px; overflow-y: auto; overflow-x: hidden;" data-bind="if: isFunctionField">
                <div data-bind="template: 'custom-function-designer', data: $data"></div>
            </div>
        </div>
            ...
            <div class="modal-body needs-validation" style="overflow-y: auto; flex-grow: 1;">
               <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="customFunctionSection" data-bind="if: isFunctionField() && ReportType() === 'List'" class="custom-field-design">
                            <br />
                            <div class="card">
                                <div class="card-header">
                                    <b>Build Custom Field</b>
                                </div>
                                <div class="card-body" data-bind="template: 'custom-function-designer'">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div data-bind="template: 'json-field-picker'">
                        </div>
                        <div id="customFieldSection" data-bind="if: isFormulaField" class="custom-field-design">
                            <br />
                            <div class="card">
                                <div class="card-header">
                                    <b>Build Custom Field</b>
                                </div>
                                <div class="card-body" data-bind="template: 'custom-field-designer'">
